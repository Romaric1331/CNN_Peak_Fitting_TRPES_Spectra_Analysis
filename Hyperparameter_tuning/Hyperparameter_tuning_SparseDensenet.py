# -*- coding: utf-8 -*-
"""
Created on Fri Jul 19 12:13:19 2024
...
import io, os
#%% Function def
def define_sparse_densenet(energy_n, filters, strides, kernel_size, learning_rate, dense_units):
    ...
    # resnet 1
    x = Conv1D(32, 4, strides=2, padding="same", kernel_initializer="he_normal")(input_data)
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    
    x = Conv1D(32, 4, strides=1, padding="same", kernel_initializer="he_normal")(x)
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    
    x = Conv1D(32, 3, strides=1, padding="same", kernel_initializer="he_normal")(x)
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    ...
    shortcut_dense = x
    shortcut = x
    shortcut = Conv1D(64, 1, strides=1, padding="valid", kernel_initializer="he_normal")(shortcut)
    
    
    # ------------------ first layer-1
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(64, 3, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    ...
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(int(96*Cf), 1, strides=1, padding="same", kernel_initializer="he_normal")(x)  # 나누기 2
    ...
    shortcut = x
    shortcut = Conv1D(128, 1, strides=1, padding="valid", kernel_initializer="he_normal")(shortcut)
    
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(128, 3, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    ...
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(int(176*Cf), 1, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    ...
    shortcut = x
    shortcut = Conv1D(256, 1, strides=1, padding="valid", kernel_initializer="he_normal")(shortcut)
    
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(256, 3, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    ...
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(int(334*Cf), 1, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    x = AveragePooling1D(3, padding="same", strides=2)(x)
    ...
    shortcut_dense = x
    shortcut = x
    shortcut = Conv1D(512, 1, strides=1, padding="valid", kernel_initializer="he_normal")(shortcut)
    
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(512, 3, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    ...
    x = BatchNormalization()(x)
    x = LeakyReLU(alpha=0.01)(x)
    x = Conv1D(int(679*Cf), 1, strides=1, padding="same", kernel_initializer="he_normal")(x)  # divide by 2
    x = AveragePooling1D(3, padding="same", strides=2)(x)
...
def objective(trial):
    ...
    model = define_sparse_densenet(energy_n, filters, strides, kernel_size, learning_rate, dense_units)
...
output_directory = "C:/Users/rsallustre/Documents/GitHub/IA_spectro/Hyperparameter_tuning/sparse_densenet/"
...
# Save HTML files
fig1.write_html(output_directory + 'optimization_histor_sparse_densenet.html', auto_open=True)
fig2.write_html(output_directory + 'parallel_coordinate_sparse_densenet.html', auto_open=True)
fig3.write_html(output_directory + 'slice_plot_sparse_densenet.html', auto_open=True)
fig4.write_html(output_directory + 'param_importances_sparse_densenet.html', auto_open=True)


# Save the best value to a text file
with open(output_directory + 'study_sparse_densenet_summary.txt', 'w') as f:
